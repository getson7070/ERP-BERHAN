...
# --- Ensure /app is on sys.path so "import erp" always works ---
...
# --- Guard logging: only if sections exist ---
...
# --- DB URL (env first, fallback second) ---
...
def _discover_metadata():
    # Preferred: central SQLAlchemy() exposing .metadata
    candidates = [
        ("erp.extensions", "db"),
        ("erp.db",         "db"),
        ("erp",            "db"),
