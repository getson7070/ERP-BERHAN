...
3) For existing DB:
   - Normal: `python tools/repair_migration_heads.py` (auto DB prep, merge heads, stamp missing revisions, upgrade to head)
   - For a dry preview without writes: `python tools/repair_migration_heads.py --dry-run`
