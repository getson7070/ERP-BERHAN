...
- **MFA not enforced by role**: `require_roles` performs role gating only; admin/management MFA requirement is not enforced during privileged actions or approval endpoints, leaving elevated sessions without guaranteed second factor.【F:erp/security.py†L60-L118】
