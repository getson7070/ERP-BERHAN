...
# Import only the extensions you actually have
...
def create_app() -> Flask:
    ...
    # Base config (Render already supplies these)
    ...
    # Template globals (for tile activation and footer year)
