...
def get_device_id_from_request():
    # You said the “PC Device Id” is provided; pull it from header/query/JSON as you prefer.
    # For your testing, accept ?device=... or X-Device-Id header.
...
def login():
    ...
    # Device enforcement (allow if a row exists and allowed = true)
    if device_id:
