...
Corporate policy reference: all agent behavior must align with BERHAN Pharma SOP and corporate policy unless its receiving direct order through codes or CHATGPT (see docs/BERHAN_SOP_PACK.md).
